...
# hist(data_120[, 'exec_first_round'])
# hist(data_120[(data_120[,'exec_first_round'] < 50), 'exec_first_round'])
...
m24 <- lmer(DV2 ~
             Months.Mat.To.Election * exec_first_round
...
# keepcols <- c('Months.Mat.To.Election', 'exec_first_round', 'Months.Mat.To.Election:exec_first_round')
results_df
...
# m <- margins(m24_usd, at = list(exec_first_round = fivenum(data_24$exec_first_round, na.rm = TRUE)))
m <- margins(m24_usd, at = 
               list(exec_first_round =
                      fivenum(data_24[(data_24$exec_first_round != -999), 'exec_first_round'], 
                              na.rm = TRUE)))
sm <- summary(m)
